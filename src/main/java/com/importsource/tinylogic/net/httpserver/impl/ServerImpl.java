...
import com.importsource.tinylogic.net.httpserver.Filter;
import com.importsource.tinylogic.net.httpserver.Headers;
import com.importsource.tinylogic.net.httpserver.HttpContext;
...
import com.importsource.tinylogic.net.httpserver.HttpsConfigurator;
import com.importsource.tinylogic.net.httpserver.impl.HttpConnection.State;
    ...
    class Exchange implements Runnable {
        ...
        void reject (int code, String requestStr, String message) {
           ...
           /* sendReply (
            ...
            sendReply (
                    code, false, "<h1>Welcome to TinyLogic</h1>"+message
                );
            closeConnection(connection);
        }
